...
class MainActivity : AppCompatActivity() {
	...
	// new function to draw rectangle around face given canvas and arrayOf faces
	/*
	private fun drawRectAroundFace() {
		(0 until rectOfFaces.size()).forEach { i ->
			val rect = rectOfFaces[i]
